...
Autores: 	Gabriel Santa Clara Ucelli
...
#################################### INSTRUÇÕES ####################################
	  ...
	  TECLAS													FUNÇÃO
		...
		A	-----------------------------------------	Gira a roda para esquerda
		D	-----------------------------------------	Gira a roda para a direita
	...
	Movimento do Mouse	-----------------------------	Movimenta o canhão


####################################################################################
Vitória: Para ganhar você tem que cruzar a linha de chegada dando uma volta completa
na arena no sentido anti-horário.
